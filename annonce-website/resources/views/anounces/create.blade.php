...
<div class="container">
    <div class="row justify-content-center my-5">
        <div class="col-md-8">
            ...
            @endif
            <div class="card">
                <div class="card-header">Create anounce</div>

                <div class="card-body">
                    <form  action="{{ url('add-anounce') }}" method="POST">
                        @csrf
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="file" class="form-control @error('photo') is-invalid @enderror" name="photo" value="{{ old('photo') }}" required autocomplete="photo" autofocus>
